package com.springjwt.Authentication.exception;
...
import com.springjwt.Authentication.model.AppResponse;
    ...
    public Response toResponse(Exception exception) {
        ...
        switch (exception.getClass().getSimpleName()) {
            ...
            case "NotAuthorizedException":
                return builder.entity(responseMap).status(Status.UNAUTHORIZED).type("application/json").build();
            default:
